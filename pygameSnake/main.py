...
class Snake:
    ...
    def draw_snake(self):
        ...
        for index, block in enumerate(self.body):
            ...
            elif index == len(self.body) - 1:  # self.body[-1]:
...
class Fruit:
    ...
    def draw_fruit(self):
        fruit_rect = pygame.Rect(int(self.pos.x * cell_size), (self.pos.y * cell_size), cell_size, cell_size)
...
# Fruit, snake graphic in snake class
